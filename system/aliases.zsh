...
alias update='sudo softwareupdate -i -a; brew update; brew upgrade; pushd ~/.vim/bundle/vim-cdadia; git pull; vim +BundleInstall! +qall; vim +PowerlineClearCache +qall; popd'
