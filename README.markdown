...
prejudiced mix: OS X, zsh, Ruby, Rails, git, homebrew, rbenv, vim, emacs, go,
kotlin. If you match up along most of those lines, you may dig my dotfiles.
...
```sh
git clone https://github.com/cdadia/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
